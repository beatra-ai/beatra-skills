...
directly instead: the field shows how the season's strong outfit notes are shot and captioned; a pasted reference note returns its images; the comments say which piece readers asked about; and the account's own recent notes keep the lookbook consistent with what the account already publishes.
