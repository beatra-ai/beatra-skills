...
PACKAGE_SLUG = "wealth-product-talking"
PACKAGE_DISPLAY_NAME = "Wealth Product Talking Clips"
PACKAGE_VERSION = "0.1.3"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/wealth-product-talking/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/wealth-product-talking/v{version}"
