...
PACKAGE_SLUG = "risk-grade-set"
PACKAGE_DISPLAY_NAME = "Risk Grade Set"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/risk-grade-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/risk-grade-set/v{version}"
