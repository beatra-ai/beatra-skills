# New manager week voice workflow

## Slot list

Write one slot per written first-week item before any paid call.
Default ten slots unless the desk names another count in 8 to 20:
welcome, team, tools, meetings, people, sites, contacts, deadlines,
reminder, and follow-up. Each slot names the spoken line from the
written first-week checklist. Do not write a performance conclusion,
a grade, or a fitness-to-lead line. The labeled list is the free
...
```json
{
  ...
  "voice": "voice_...",
  "format": "mp3",
  "client_request_id": "opaque-manager-speech-01"
}
```
...
pronunciation table and the written first-week checklist. Do not write
a performance conclusion or a grade. After a returned `task_id`, poll
