...
PACKAGE_SLUG = "new-manager-voice"
PACKAGE_DISPLAY_NAME = "New Manager Week Voice Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/new-manager-voice/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/new-manager-voice/v{version}"
