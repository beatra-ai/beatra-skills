...
For a generic topic carousel, use `rednote-carousel-maker`; for one isolated
cover, use `rednote-cover-maker`. Keep the user's stated dish, restaurant,
...
Planning, post writing, and prompt drafting are free. Before generation or a
