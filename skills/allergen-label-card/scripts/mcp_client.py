...
PACKAGE_SLUG = "allergen-label-card"
PACKAGE_DISPLAY_NAME = "Allergen Explanation Card"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/allergen-label-card/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/allergen-label-card/v{version}"
