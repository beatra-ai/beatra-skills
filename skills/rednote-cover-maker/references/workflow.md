...
```json
{
  ...
  "client_request_id": "rednote-cover-transform-001"
}
```
...
```json
{
  ...
  "client_request_id": "rednote-cover-ootd-001"
}
```
...
```json
{
  ...
  "client_request_id": "rednote-cover-concept-001"
}
```
...
```json
{
  ...
  "client_request_id": "rednote-cover-refine-001"
}
```
...
```json
{
  ...
  "client_request_id": "rednote-cover-fix-spot-001"
}
```
