...
PACKAGE_SLUG = "livestream-bgm-pack"
PACKAGE_DISPLAY_NAME = "Livestream BGM Pack"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/livestream-bgm-pack/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/livestream-bgm-pack/v{version}"
