...
PACKAGE_SLUG = "tax-policy-brief-clip"
PACKAGE_DISPLAY_NAME = "Tax Policy Brief Clip"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/tax-policy-brief-clip/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/tax-policy-brief-clip/v{version}"
