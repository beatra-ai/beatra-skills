...
PACKAGE_SLUG = "fund-page-set"
PACKAGE_DISPLAY_NAME = "Fund Factsheet Page"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/fund-page-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/fund-page-set/v{version}"
