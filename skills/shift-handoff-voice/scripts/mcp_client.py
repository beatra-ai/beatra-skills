...
PACKAGE_SLUG = "shift-handoff-voice"
PACKAGE_DISPLAY_NAME = "Shift Handoff Voice Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/shift-handoff-voice/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/shift-handoff-voice/v{version}"
