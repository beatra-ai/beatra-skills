...
PACKAGE_SLUG = "store-new-item-launch"
PACKAGE_DISPLAY_NAME = "Store New Item Launch"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/store-new-item-launch/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/store-new-item-launch/v{version}"
