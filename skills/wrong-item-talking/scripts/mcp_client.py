...
PACKAGE_SLUG = "wrong-item-talking"
PACKAGE_DISPLAY_NAME = "Wrong Item Talking Clips"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/wrong-item-talking/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/wrong-item-talking/v{version}"
