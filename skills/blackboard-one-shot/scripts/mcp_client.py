...
PACKAGE_SLUG = "blackboard-one-shot"
PACKAGE_DISPLAY_NAME = "Blackboard One-Shot Clips"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/blackboard-one-shot/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/blackboard-one-shot/v{version}"
