...
PACKAGE_SLUG = "cs-macro-card-set"
PACKAGE_DISPLAY_NAME = "CS Macro Card Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/cs-macro-card-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/cs-macro-card-set/v{version}"
