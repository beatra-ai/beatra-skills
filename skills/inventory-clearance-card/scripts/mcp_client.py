...
PACKAGE_SLUG = "inventory-clearance-card"
PACKAGE_DISPLAY_NAME = "Clearance Explanation Cards"
PACKAGE_VERSION = "0.1.3"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/inventory-clearance-card/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/inventory-clearance-card/v{version}"
