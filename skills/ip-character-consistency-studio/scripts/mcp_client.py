...
PACKAGE_SLUG = "ip-character-consistency-studio"
PACKAGE_DISPLAY_NAME = "AI Character Design Sheet & Consistency Studio"
PACKAGE_VERSION = "0.1.3"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/ip-character-consistency-studio/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/ip-character-consistency-studio/v{version}"
