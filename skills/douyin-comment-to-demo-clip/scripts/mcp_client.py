...
PACKAGE_SLUG = "douyin-comment-to-demo-clip"
PACKAGE_DISPLAY_NAME = "Douyin Comment Demo Clips"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/douyin-comment-to-demo-clip/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/douyin-comment-to-demo-clip/v{version}"
