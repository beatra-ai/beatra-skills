...
PACKAGE_SLUG = "sku-comparison-chart"
PACKAGE_DISPLAY_NAME = "SKU Comparison Charts"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/sku-comparison-chart/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/sku-comparison-chart/v{version}"
