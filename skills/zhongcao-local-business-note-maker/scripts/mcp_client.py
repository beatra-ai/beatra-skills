...
PACKAGE_SLUG = "zhongcao-local-business-note-maker"
PACKAGE_DISPLAY_NAME = "Zhongcao Local Business Note Maker"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/zhongcao-local-business-note-maker/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/zhongcao-local-business-note-maker/v{version}"
