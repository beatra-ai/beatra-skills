...
directly instead: the field shows how the neighbourhood's strong notes name a place and a reason to go; a pasted reference note fixes one exactly; the comments give the practical questions readers ask — parking, queue, hours, price; and the account's own recent notes keep the voice consistent.
