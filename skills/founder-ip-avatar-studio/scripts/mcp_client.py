...
PACKAGE_SLUG = "founder-ip-avatar-studio"
PACKAGE_DISPLAY_NAME = "Founder IP Avatar Studio"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/founder-ip-avatar-studio/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/founder-ip-avatar-studio/v{version}"
