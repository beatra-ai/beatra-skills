# Xiaohongshu policy-question note lookup

Policy-question notes normally come from the desk. This route exists
when they give a public Xiaohongshu note link or search wording and
this connection can read it.
...
Never ask for an internal ID the desk would have to go find.
...
A looked-up policy question is labelled as looked up, with the date
it was read. A pasted question stays marked as supplied. A missing
public-policy line is stated as missing. Never estimate, interpolate,
or invent a subsidy amount, eligibility rule, or personalized grant
from a similar note.
