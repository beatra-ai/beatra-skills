...
Only when a clip was included. Show the exact approved opening frame and narration artifacts, the motion direction, the selected model, the computed duration, and the paid boundary. Freeze them under a new stable `client_request_id`.
