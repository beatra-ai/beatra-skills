...
PACKAGE_SLUG = "creator-drop-talking"
PACKAGE_DISPLAY_NAME = "Creator Drop Talking Clips"
PACKAGE_VERSION = "0.1.3"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/creator-drop-talking/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/creator-drop-talking/v{version}"
