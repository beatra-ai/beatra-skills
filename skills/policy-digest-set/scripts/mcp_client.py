...
PACKAGE_SLUG = "policy-digest-set"
PACKAGE_DISPLAY_NAME = "Policy Digest Pages"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/policy-digest-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/policy-digest-set/v{version}"
