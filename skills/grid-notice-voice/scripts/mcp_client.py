...
PACKAGE_SLUG = "grid-notice-voice"
PACKAGE_DISPLAY_NAME = "Grid Notice Voice Pack"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/grid-notice-voice/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/grid-notice-voice/v{version}"
