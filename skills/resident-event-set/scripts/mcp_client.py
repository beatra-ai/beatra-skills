...
PACKAGE_SLUG = "resident-event-set"
PACKAGE_DISPLAY_NAME = "Resident Event Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/resident-event-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/resident-event-set/v{version}"
