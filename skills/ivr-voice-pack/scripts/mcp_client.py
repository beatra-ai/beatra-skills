...
PACKAGE_SLUG = "ivr-voice-pack"
PACKAGE_DISPLAY_NAME = "IVR Voice Pack"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/ivr-voice-pack/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/ivr-voice-pack/v{version}"
