...
PACKAGE_SLUG = "music-lyric-set"
PACKAGE_DISPLAY_NAME = "Music Lyric Card Set"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/music-lyric-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/music-lyric-set/v{version}"
