...
PACKAGE_SLUG = "project-handover-sign-set"
PACKAGE_DISPLAY_NAME = "Project Handover Sign Set"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/project-handover-sign-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/project-handover-sign-set/v{version}"
