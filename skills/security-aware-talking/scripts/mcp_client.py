...
PACKAGE_SLUG = "security-aware-talking"
PACKAGE_DISPLAY_NAME = "Security Awareness Talking Clips"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/security-aware-talking/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/security-aware-talking/v{version}"
