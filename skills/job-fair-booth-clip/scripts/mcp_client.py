...
PACKAGE_SLUG = "job-fair-booth-clip"
PACKAGE_DISPLAY_NAME = "Job Fair Booth Talks"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/job-fair-booth-clip/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/job-fair-booth-clip/v{version}"
