# Job-fair booth talking-clip workflow

## Clip list

Write one list item per still before any paid call. Default three
clips unless the team names another count in 2 to 8: booth welcome,
role, and next step. Each item names the still, the spoken line from
confirmed role notes, and a planned 2–15s window. Do not invent a
salary, headcount, booth number, or unseen workplace fact. The
...
```json
{
  "input": "<the written booth line for this clip>",
  "voice": "voice_...",
  "format": "mp3",
  "client_request_id": "opaque-booth-speech-01"
}
```
...
```json
{
  "image": {"type": "artifact", "artifact_id": "art_booth_01"},
  "driving_audio": {"type": "artifact", "artifact_id": "art_booth_speech_01"},
  "prompt": "A restrained booth welcome from this still. Keep face, booth, and lighting stable.",
  "duration": 8,
  "client_request_id": "opaque-booth-video-01"
}
```
