...
PACKAGE_SLUG = "wealth-open-cal-set"
PACKAGE_DISPLAY_NAME = "Wealth Open Calendar"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/wealth-open-cal-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/wealth-open-cal-set/v{version}"
