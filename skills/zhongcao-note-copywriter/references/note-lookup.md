...
directly instead: the field tells the note's structure what it is competing against; a pasted reference note fixes what actually ran; the comments give the audience's own words, which is where a hook line comes from; and the account's own recent notes keep the voice consistent with what its readers already expect.
