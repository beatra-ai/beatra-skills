...
PACKAGE_SLUG = "kyc-guide-set"
PACKAGE_DISPLAY_NAME = "KYC Guide Set"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/kyc-guide-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/kyc-guide-set/v{version}"
