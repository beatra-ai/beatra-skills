...
PACKAGE_SLUG = "game-ui-voice-pack"
PACKAGE_DISPLAY_NAME = "Game UI Voice Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/game-ui-voice-pack/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/game-ui-voice-pack/v{version}"
