...
PACKAGE_SLUG = "bilibili-publishing-pack"
PACKAGE_DISPLAY_NAME = "Bilibili Publishing Pack"
PACKAGE_VERSION = "0.1.5"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/bilibili-publishing-pack/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/bilibili-publishing-pack/v{version}"
