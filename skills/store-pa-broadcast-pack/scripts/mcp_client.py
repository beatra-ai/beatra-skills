...
PACKAGE_SLUG = "store-pa-broadcast-pack"
PACKAGE_DISPLAY_NAME = "Store PA Broadcast Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/store-pa-broadcast-pack/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/store-pa-broadcast-pack/v{version}"
