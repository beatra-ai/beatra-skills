...
PACKAGE_SLUG = "duty-board-set"
PACKAGE_DISPLAY_NAME = "Duty Board Pack"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/duty-board-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/duty-board-set/v{version}"
