...
PACKAGE_SLUG = "stitch-prompt-card"
PACKAGE_DISPLAY_NAME = "Stitch Prompt Card"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/stitch-prompt-card/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/stitch-prompt-card/v{version}"
