...
PACKAGE_SLUG = "lab-cover-set"
PACKAGE_DISPLAY_NAME = "Lab Cover Set"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/lab-cover-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/lab-cover-set/v{version}"
