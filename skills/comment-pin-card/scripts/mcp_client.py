...
PACKAGE_SLUG = "comment-pin-card"
PACKAGE_DISPLAY_NAME = "Pin Comment Cards"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/comment-pin-card/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/comment-pin-card/v{version}"
