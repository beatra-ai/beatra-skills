...
PACKAGE_SLUG = "publish-preflight-studio"
PACKAGE_DISPLAY_NAME = "Publish Preflight Studio"
PACKAGE_VERSION = "0.1.3"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/publish-preflight-studio/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/publish-preflight-studio/v{version}"
