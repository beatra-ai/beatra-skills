...
directly instead: the field shows how the category's strong food notes frame a dish; a pasted reference note fixes one exactly, including its images; the comments give the questions readers actually ask — price, portion, where; and the account's own recent notes keep the voice consistent.
