...
PACKAGE_SLUG = "hanzi-card-set"
PACKAGE_DISPLAY_NAME = "Hanzi Card Set"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/hanzi-card-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/hanzi-card-set/v{version}"
