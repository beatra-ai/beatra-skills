...
PACKAGE_SLUG = "real-estate-listing-set"
PACKAGE_DISPLAY_NAME = "Listing Still Sets"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/real-estate-listing-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/real-estate-listing-set/v{version}"
