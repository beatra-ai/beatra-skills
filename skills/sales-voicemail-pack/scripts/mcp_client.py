...
PACKAGE_SLUG = "sales-voicemail-pack"
PACKAGE_DISPLAY_NAME = "Sales Voicemail Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/sales-voicemail-pack/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/sales-voicemail-pack/v{version}"
