# Earnings script voice workflow

## Slot list

Write one slot per official-script section before any paid call.
Default ten slots unless the seller names another count in 8 to 20:
headline, revenue, profit, guidance, CEO remark, CFO remark,
outlook, prepared Q&A, close, and disclaimer. Each slot names the
spoken line from the official script. Do not invent revenue,
guidance, a quote, or a reading. The labeled list is the free
...
```json
{
  "input": "Revenue for the quarter was as written in the official script.",
  "voice": "voice_...",
  "format": "mp3",
  "client_request_id": "opaque-earnings-speech-01"
}
```
...
figures match the pronunciation table and the official script. After
