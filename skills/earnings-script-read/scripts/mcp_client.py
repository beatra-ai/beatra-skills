...
PACKAGE_SLUG = "earnings-script-read"
PACKAGE_DISPLAY_NAME = "Earnings Script Reads"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/earnings-script-read/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/earnings-script-read/v{version}"
