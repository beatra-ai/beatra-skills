...
PACKAGE_SLUG = "audio-drama-voice-studio"
PACKAGE_DISPLAY_NAME = "Audio Drama Voice Studio"
PACKAGE_VERSION = "0.1.7"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/audio-drama-voice-studio/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/audio-drama-voice-studio/v{version}"
