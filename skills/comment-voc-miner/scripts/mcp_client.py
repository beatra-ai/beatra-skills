...
PACKAGE_SLUG = "comment-voc-miner"
PACKAGE_DISPLAY_NAME = "Comment VOC Miner"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/comment-voc-miner/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/comment-voc-miner/v{version}"
