...
PACKAGE_SLUG = "tool-demo-clip"
PACKAGE_DISPLAY_NAME = "Tool Demo One-Shot Clips"
PACKAGE_VERSION = "0.1.3"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/tool-demo-clip/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/tool-demo-clip/v{version}"
