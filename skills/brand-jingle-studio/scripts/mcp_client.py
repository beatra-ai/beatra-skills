...
PACKAGE_SLUG = "brand-jingle-studio"
PACKAGE_DISPLAY_NAME = "Brand Jingle Studio"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/brand-jingle-studio/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/brand-jingle-studio/v{version}"
