...
PACKAGE_SLUG = "bank-desk-board-set"
PACKAGE_DISPLAY_NAME = "Bank Desk Board Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/bank-desk-board-set/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/bank-desk-board-set/v{version}"
