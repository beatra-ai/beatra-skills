...
PACKAGE_SLUG = "wechat-article-visual-pack"
PACKAGE_DISPLAY_NAME = "WeChat Article Visual Pack"
PACKAGE_VERSION = "0.1.3"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/wechat-article-visual-pack/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/wechat-article-visual-pack/v{version}"
