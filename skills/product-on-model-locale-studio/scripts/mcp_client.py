...
PACKAGE_SLUG = "product-on-model-locale-studio"
PACKAGE_DISPLAY_NAME = "AI Product-on-Model Locale Studio"
PACKAGE_VERSION = "0.1.3"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/product-on-model-locale-studio/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/product-on-model-locale-studio/v{version}"
