...
PACKAGE_SLUG = "incident-brief-voice"
PACKAGE_DISPLAY_NAME = "Incident Brief Voice Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/incident-brief-voice/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/incident-brief-voice/v{version}"
