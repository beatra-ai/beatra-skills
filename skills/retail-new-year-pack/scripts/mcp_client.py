...
PACKAGE_SLUG = "retail-new-year-pack"
PACKAGE_DISPLAY_NAME = "Retail New Year Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/retail-new-year-pack/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/retail-new-year-pack/v{version}"
