# Xiaohongshu parent FAQ lookup

Parent questions normally come from the user. This route exists when they
...
A looked-up parent question is labelled as looked up, with the date it
was read. A pasted question stays marked as supplied. A missing
answer line is stated as missing. Never estimate, interpolate, invent
a teaching fact, or print a score from a similar note.
