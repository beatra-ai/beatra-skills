# Account opening voice workflow

## Slot list

Write one slot per written opening step before any paid call. Default
ten slots unless the desk names another count in 8 to 20: welcome,
materials, identity, bank-link, risk-grade, e-sign, password, deposit,
app, and complete. Each slot names the spoken line from the written
step list. Do not invent a materials line, a yield, or a reading. The
...
Skip clone unless the desk wants a cloned teller voice and can
...
```json
{
  ...
  "voice": "voice_...",
  "format": "mp3",
  "client_request_id": "opaque-broker-speech-01"
}
```
...
pronunciation table and the written step list. After a returned
