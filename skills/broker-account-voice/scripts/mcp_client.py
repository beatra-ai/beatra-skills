...
PACKAGE_SLUG = "broker-account-voice"
PACKAGE_DISPLAY_NAME = "Account Opening Voice Pack"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/broker-account-voice/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/broker-account-voice/v{version}"
