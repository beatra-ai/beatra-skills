...
PACKAGE_SLUG = "rednote-local-business-note-maker"
PACKAGE_DISPLAY_NAME = "REDnote Local Business Note Maker"
PACKAGE_VERSION = "0.1.1"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/rednote-local-business-note-maker/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/rednote-local-business-note-maker/v{version}"
