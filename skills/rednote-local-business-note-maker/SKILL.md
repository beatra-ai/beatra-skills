---
name: "rednote-local-business-note-maker"
...
`rednote-food-note-maker`; route a generic multi-image topic to
`rednote-carousel-maker`; route one isolated post cover to
`rednote-cover-maker`; and route an outfit-led note to
...
Planning, post writing, and prompt drafting are free. Before image generation
