...
PACKAGE_SLUG = "voice-clone-series-studio"
PACKAGE_DISPLAY_NAME = "Voice Clone Series Studio"
PACKAGE_VERSION = "0.1.2"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/voice-clone-series-studio/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/voice-clone-series-studio/v{version}"
