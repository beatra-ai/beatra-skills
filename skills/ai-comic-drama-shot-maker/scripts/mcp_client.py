...
PACKAGE_SLUG = "ai-comic-drama-shot-maker"
PACKAGE_DISPLAY_NAME = "AI Comic Drama Shot Maker"
PACKAGE_VERSION = "0.1.4"
PACKAGE_CHANNEL = "canonical"
PACKAGE_LOCALE = "en"
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/ai-comic-drama-shot-maker/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/ai-comic-drama-shot-maker/v{version}"
