# Training handout still workflow
...
handout line taken from those captions, layout, and canvas.
...
video or search, follow [training caption lookup](caption-lookup.md)
...
caption-backed handout line. After a returned `task_id`, poll that task.
...
byte-identical arguments. A changed caption, handout line, still,
