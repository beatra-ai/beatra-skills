# Booking confirmation voice workflow

## Slot list

Write one slot per booking notice before any paid call. Default ten
slots unless the seller names another count in 8 to 20: confirmed,
rescheduled, cancelled, reminder, running late, no-show, waitlist,
arrival, deposit, and closed. Each slot names the spoken line from
confirmed facts. Do not invent a time, price, offer, or reading. The
...
```json
{
  "input": "Your booking is confirmed for Saturday at three.",
  "voice": "voice_...",
  "format": "mp3",
  "client_request_id": "opaque-booking-speech-01"
}
```
...
pronunciation table. After a returned `task_id`, poll that task. If
